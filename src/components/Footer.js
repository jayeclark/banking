            ...
            <div className="footer-social">
                <div id="globalSocialModule">
                    <div className="social">
                        ...
                        <a href="#globalSocialModule" id="social_follow_facebook_link" className="social-network">
                        ...
                        <a href="#globalSocialModule" id="social_follow_instagram_link" className="social-network">
                        ...
                        <a href="#globalSocialModule" id="social_follow_linkedin_link" className="social-network">
                        ...
                        <a href="#globalSocialModule" id="social_follow_twitter_link" className="social-network">
