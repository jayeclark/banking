            ...
            <div className="footer-social">
                <div id="globalSocialModule">
                    <div className="social">
                        ...
                        <a href="https://www.facebook.com/BankofAmerica/" rel="noreferrer" target="_blank" id="social_follow_facebook_link" className="social-network">
                        ...
                        <a href="https://www.instagram.com/bankofamerica/" rel="noreferrer"  target="_blank" id="social_follow_instagram_link" className="social-network">
                        ...
                        <a href="https://www.linkedin.com/company/bank-of-america" rel="noreferrer"  target="_blank" id="social_follow_linkedin_link" className="social-network">
                        ...
                        <a href="https://twitter.com/BankofAmerica" target="_blank" rel="noreferrer"  id="social_follow_twitter_link" className="social-network">
